...
const config: MenuEntry[] = [
  ...
  },
  {
    label: 'Farms',
    icon: 'FarmIcon',
    href: 'https://fenixfinance.net/farms',
  },
  {
    label: 'Pools',
    icon: 'PoolIcon',
    href: 'https://fenixfinance.net/pools',
  },
  {
    label: 'Lottery',
    icon: 'TicketIcon',
    href: 'https://fenixfinance.net/lottery',
  },
  {
    label: 'LaunchPad IFO',
    icon: 'IfoIcon',
    href: 'https://fenixfinance.net/ifo',
  },
  {
